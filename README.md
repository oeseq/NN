...
3. Double click on desktop shortcut (or on .exe file within installation folder) to launch application.
4. The first time an activation code is required before a login PIN is set up.
